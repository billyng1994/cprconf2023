...
<head>
  ...
  <title>Contact Us - CPCECPR Conference 2023</title>
  <!-- Font Aewsome CSS -->
  ...
  <div class="container" style="min-height: 70vh;">
    <div class="jumbotron">
      <div style="text-align: left;">
        <h2 style="color: #111177;">CPCE Centre for Pedagogic Research (CPCECPR)</h2><br>
        
        <img align="left" src="images/cpr.jpg" class="img-responsive" style=" display: block;"><br><br><br><br><br><br><br><br><br><br><br>
        <p style="font-size: 16px">Tel: (852) 3746 0479
          <br>Email: <a href="mailto:cpr@cpce-polyu.edu.hk">cpr@cpce-polyu.edu.hk</a>
